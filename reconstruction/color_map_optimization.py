...
def load_dataset(config):
    ...
    def get_file_list(path, extension=None, step_size=1):
...
def run(config):
    ...
    print(f"non rigid_optimazer {mesh}")
    ...
    print(f"non rigid_optimazer {mesh}")
    print(
        f"color map optimization write_triangle_mesh {os.path.join(config['path_dataset'], 'scene', 'color_map.ply')}")
